Shader "Custom/MonochromeHoloPostEffect"
{
    Properties
    {
    ...
    { 
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float posterize = floor(frac(perlinNoise(_Time)) / (1 / _FrameRate)) * (1 / _FrameRate);
                ...
                //モノクロ化
                float monochrome = 0.3 * finalColor.r + 0.6 * finalColor.g + 0.1 * finalColor.b;
